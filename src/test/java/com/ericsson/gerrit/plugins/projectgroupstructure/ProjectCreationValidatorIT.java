...
public class ProjectCreationValidatorIT extends LightweightPluginDaemonTest {
  ...
  public void shouldRejectProjectNotMatchingRegexInTheirNameIfRegexContainsSlash()
      throws Exception {
    ProjectInput in = new ProjectInput();
    in.permissionsOnly = true;
  ...
  @GlobalPluginConfig(
      ...
      name = "project-group-structure.regex",
      value = REGEX_INCLUDING_SLASH)
  public void shouldAllowProjectMatchingRegexInTheirNameIfRegexContainsSlash() throws Exception {
    ProjectInput in = new ProjectInput();
    in.permissionsOnly = true;
