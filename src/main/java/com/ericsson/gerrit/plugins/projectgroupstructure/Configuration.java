...
class Configuration {
  ...
  private static final String DEFAULT_NAME_REGEX_MESSAGE =
      "The value of the regex is invalid." + ProjectCreationValidator.SEE_DOCUMENTATION_MSG;
  ...
  Configuration(
    ...
    if (!"/".matches(regexNameFilter) || " ".matches(regexNameFilter)) {
      log.warn(String.format(DEFAULT_NAME_REGEX_MESSAGE, url + "Documentation/index.html"));
