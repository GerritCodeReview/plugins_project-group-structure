...
public class ProjectCreationValidator implements ProjectCreationValidationListener {
  ...
  public static final String PROJECT_SHOULD_MATCH_REGEX = "Project name should match the regex: %s";
  ...
  public void validateNewProject(CreateProjectArgs args) throws ValidationException {
    ...
    String regex = this.config.RegexNameFilter();
    if (!regex.isEmpty() && !(name.matches(regex))) {
      throw new ValidationException(String.format(PROJECT_SHOULD_MATCH_REGEX, regex));
    }
    if (name.contains(" ")) {
