...
public class ProjectCreationValidator
  ...
  private boolean isInDelegatingGroup(ProjectControl parentCtrl) {
    try {
      ...
      if (delegateProjectCreationTo.startsWith("Group[")
        ...
        GroupReference refFromString =
            GroupReference.fromString(delegateProjectCreationTo);
        delegateProjectCreationTo = refFromString.getName();
  ...
  private boolean isMember(String username, String delegateProjectCreationTo)
      throws RestApiException {
    List<AccountInfo> accounts =
        gerritApi.groups().id(delegateProjectCreationTo).members(true);
